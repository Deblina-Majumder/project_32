...
for(var i = 0; i<playerArrows.length; i++){
  var baseCollision= Matter.SAT.callides(
   playerArrows[i].body,
   computerBase.body
  );

  var computerCollides=Matter.SAT.callides(
    playerArrows[i].body,
    computer.body
  );

  computerArcherCollision=Matter.SAT.callides(
    playerArrows[i].body,
    computerArcher.body
  );
